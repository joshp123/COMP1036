...
Object.extend(Gradebook.GradeColDef.prototype,
{
  ...
  _gradeAttempts: function ( anonymousMode ) {
   ...
   postGradingForm: function ( url ) {
      ...
      gradingForm.insert({bottom:new gcFrame.Element('input',{'type':'hidden','name':'students','value':'{"students":'+retStudents.toJSON()+'}'})});
      ...
      gradingForm.insert({bottom:new gcFrame.Element('input',{'type':'hidden','name':'items','value':'{"items":'+retItems.toJSON()+'}'})});
      gradingForm.submit();
   },
